...
<head>
    ...
    <link rel="icon" type="image/png" href="https://drive.google.com/uc?export=view&id=1WjtOJT6Eq1PoZPulS_dL4EeG3Hu82W7n"/>
    ...
    <script type="text/javascript" src="view/presentacion/js/registros.js"></script>
    <script type="text/javascript" src="view/presentacion/js/registros_formato.js"></script>
